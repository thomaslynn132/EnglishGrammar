    ...
    <>
      <div ref={container} className="container">
        <p ref={paragraphs}>
          ...
          <ol ref={(el) => (lists.current[0] = el)} type="123">
            <li>
          ...
          <ol ref={(el) => (lists.current[1] = el)} type="123">
            <li>Simple Noun (Eg. Bike, House, Liquor)</li>
          ...
          <br />
          <h5 ref={(el) => (headings.current[8] = el)}>3. Phrasal Noun</h5>
          A noun that is formed by combining a noun and a preposition creating a
          new meaning is called a phrasal noun.
          <br /> (Eg. breakup (break+up), takeoff (take+off), handout
          (hand+out))
          <h5 ref={(el) => (headings.current[9] = el)}>
            4. Noun derived from other words
          </h5>
          Some nouns are derived mostly from gerunds (V-ing) or adjectives.
          <br /> (Eg. swimming, reading, happiness, kindness)
          <br />
          <br />
        </p>
        <h3 ref={(el) => (headings.current[10] = el)}>
          Changing Singular Nouns Into Plural Nouns
        </h3>
        <div className="SgToPl">
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[11] = el)}>Simply adding -s</h5>
            Example
            <br />
            Boy - Boys
            <br />
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[12] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[13] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[14] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[15] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[16] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[17] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[18] = el)}>Irregular nouns</h5>
            Example
            <br />
            man - men
            <br />
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[19] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[20] = el)}>
              By adding "en" or "ren"
            </h5>
            Example
            <br />
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[21] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[22] = el)}>
              Some nouns end in "-a"
            </h5>
            Example
            <br />
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[23] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[24] = el)}>
          ...
          <div className="MiniSgToPl">
            <h5 ref={(el) => (headings.current[25] = el)}>
